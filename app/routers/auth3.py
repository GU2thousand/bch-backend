...
from app.services.xp_service import grant_login_streak_xp
...
async def login(data: UserLogin, session: AsyncSession = Depends(get_session)):
    ...
    await grant_login_streak_xp(user, session)
    # TODO: include "streak_xp_awarded: true/false and current_login_streak in return response for UI"
